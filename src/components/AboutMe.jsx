...
const skillsData = [
  {
    label: 'Figma',
    value: 100,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff"><circle cx="12" cy="12" r="10" /></svg>`
  },
  {
    label: 'Adobe XD',
    value: 100,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="purple"><rect width="24" height="24" /></svg>`
  },
  {
    label: 'Adobe Photoshop',
    value: 85,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="blue"><text x="0" y="20" font-size="20">Ps</text></svg>`
  },
  {
    label: 'Shopify',
    value: 60,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="orange"><text x="0" y="20" font-size="20">Ai</text></svg>`
  },
  {
    label: 'Hubspot',
    value: 70,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="purple"><text x="0" y="20" font-size="20">Pr</text></svg>`
  }
];
    ...
    <section ref={sectionRef} className="bg-black text-white py-16 ">
      <div className="max-w-[1400px]  mx-auto text-center px-5" >
        ...
        <div className='md:w-[60%] flex flex-col items-start gap-10'>
            <p className=" text-gray-300 text-left xl:text-[24px] lg:text-[20px] text-[16px]">
              ...
              <div className="w-24 h-24 mx-auto relative !mb-4">
                <svg className="w-full h-full transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeDashoffset={251.2 - (251.2 * progressValues[index]) / 100}
                    strokeLinecap="round"
                    style={{ transition: 'stroke-dashoffset 0.2s' }}
                  />
                </svg>
                <div
                    className="absolute inset-0 flex items-center justify-center text-xl font-bold text-white svg-col"
