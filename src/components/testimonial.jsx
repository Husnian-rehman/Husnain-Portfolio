...
export default function Testimonial() {
  ...
  return (
    <div className='bg-featurebg pt-[40px]  md:pt-[88px] pb-[100px] md:pb-[146px] text-white'>
        <div className="max-w-[1180px] m-auto px-5">
          <div className='col_text mb-10 flex flex-col items-center'>
                <span className="block text-center md:mb-10 mb-5 md:text-[40px] text-[20px] font-bold  text-white">
                    Testimonials                </span>
                <div className='mb-10'>
 ...
 {/* Splide Carousel */}
        <Splide
            ...
            <SplideSlide>
                ...
                <h3 className='mb-2 text-2xl  font-semibold text-center'>DF. Carter</h3>
                <p className='text-xl mb-5  font-medium italic text-center'>Mobility Supplier, USA</p>
                <p className='text-xl text-description  font-normal text-center'>
                    Reliable billing support that improved our cash flow and reduced claim issues.
            ...
            <SplideSlide>
                ...
                <h3 className='mb-2 text-2xl  font-semibold text-center'>Jane Doe</h3>
                <p className='text-xl  mb-5 font-medium italic text-center'>Therapist, Canada</p>
                <p className='text-xl text-description  font-normal text-center'>
                    Professional service that simplified our billing and improved reimbursements.
                </p>
                </div>
            </SplideSlide>
        </Splide>
